...
\tilde{\mathbf{r}}_i^n \rightarrow \frac{\tilde{\mathbf{r}}_i^n}{\left|\tilde{\mathbf{r}}_i^n
\right|}=\frac{\left[\tilde{x}_i^n, \tilde{y}_i^n, \tilde{z}^n\right]}{\sqrt{\left(\tilde{x}_i^n
\right)^2+\left(\tilde{y}_i^n\right)^2+\left(\tilde{z}_i^n\right)^2}}
\end{equation}
